...
class MyElement extends LitElement {
  ...
  render() {
    return html`
      <p style="color: red">prop1 ${this.prop1}</p>
      ...
      <span part="box" class="${this.prop1}">span is green ${this.prop1}</span>
      ...
      <p>prop6 with calling api: ${this.prop6.title}</p>
